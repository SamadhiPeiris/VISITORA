...
$img = $_POST['image'];
 ...
 $query=mysqli_query($con,"insert into tblvisitor(FullName,Email,MobileNumber,Address,WhomtoMeet,Deptartment,ReasontoMeet, img) value('$fullname','$email','$mobnumber','$add','$whomtomeet','$department','$reasontomeet', '$file')");
    ...
    echo $msg;
											...
											<div class="row form-group">
                                                <div class="row">
													...
													<div class="col-md-6">
														<div id="results" style="margin-left:10%; margin-top: 40px; padding:20px; border:1px solid; background:#ccc;">Your captured image will appear here...</div>
													</div>
												</div>
                                            </div>
